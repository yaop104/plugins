 ...
 *
 */
public class ImageFileSaver implements IFileSaver {
	...
	public ImageFileSaver(String savePath) {
...
//			String folder = "D:\\resourcesfile\\download\\apk";
			String folder = Config.DEFAULT_APK_IMGPATH;
...
//			String realPath = folder + File.separator + newFileName;
			String realPath = Config.DEFAULT_APK_IMGPATH + File.separator  + newFileName;
