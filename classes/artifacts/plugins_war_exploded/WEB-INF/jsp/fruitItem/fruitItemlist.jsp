...
//		var State = $("#s_state").combobox("getValue");
	...
	function ys1(val, rec, index) {
		var returnvalue="<img  src='${ctx}/image/table_td_button/check.png' onclick='offItem(" + rec.tptUnid + "\")' style='cursor:pointer;width:20px;height:20px;vertical-align:middle;'/>&nbsp;<a href='javascript:void(0)' style='height:20px;line-height:30px;vertical-align:middle;' onclick='offItem(" + rec.tptUnid + "\")'>下架</a>&nbsp;&nbsp;";
		return returnvalue;
	}
	function offItem(id){
